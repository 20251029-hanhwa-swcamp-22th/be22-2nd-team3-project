...
public class ModelMapperConfig {
        ...
        public ModelMapper modelMapper() {
                ...
                configureRecipeMapping(modelMapper);
                ...
                Converter<List<RecommendRecipeResponse.IngredientDetail>, String> ingredientsConverter = context -> context
                                .getSource() == null ? null
                                                : context.getSource().stream()
                                                                .map(ing -> String.format("%s(%.1f%s)", ing.getName(),
        ...
        private void configureRecipeMapping(ModelMapper modelMapper) {
                ...
                modelMapper.createTypeMap(RecipeDTO.class, Recipe.class)
                                .addMappings(mapper -> {
                                        ...
                                        mapper.using(dishConverter).map(RecipeDTO::getDishNo, Recipe::setDishNo);
                ...
                modelMapper.createTypeMap(Recipe.class, RecipeDTO.class)
                                .addMappings(mapper -> {
                                        ...
                                        mapper.map(src -> src.getDishNo().getId(), RecipeDTO::setDishNo);
                                });
        }
